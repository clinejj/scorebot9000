    ...
    <div id="myCarousel" class="carousel slide">
          ...
          <div class="container">
                <div class="hero-unit" style="margin-top: 40px;">
                  <div class="row">
                    ...
                    <h1>2019<br>Clinelympic<br>Games</h1>
                    </div>
                    <p>The annual contest of athletic skill and mental fortitude in celebration of <a href="http://johncline.me/">John Cline</a>. Started in 2012 in honor of John's 25th year of life, the Clinelympic games has become the defining event of our time. This year's games will be held on January 12th, 2019.</p>
                  </div>
      ...
      <div class="row">
        <div class="span6">
          ...
          <p><a class="btn" href="summary.jsp?e=8">See Scores &raquo;</a></p>
          <br>
          <h2>Details</h2>
