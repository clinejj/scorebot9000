    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="row">
        <div class="span6">
          ...
          <p>Opening Ceremonies will begin at 1:00pm on Sunday, January 14th, 2017 at Gutter Bar in Williamsburg. Events will take place at Gutter Bar and Barcade in Williamsburg.</p>
          <p>Closing Ceremonies will begin at 7:00pm, at The Saint Austere in Williamsburg. After-party location TBD (probably Union Pool).</p>
          <p>Check out the scores to see live updates.</p>
          <p><a class="btn" href="summary.jsp?e=7">See Scores &raquo;</a></p>
          <br>
          <h2>Details</h2>
